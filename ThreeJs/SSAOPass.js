...
(function () {
    var AddEquation = THREE.AddEquation;
    var Color = THREE.Color;
    var CustomBlending = THREE.CustomBlending;
    var DataTexture = THREE.DataTexture;
    var DepthTexture = THREE.DepthTexture;
    var DstAlphaFactor = THREE.DstAlphaFactor;
    var DstColorFactor = THREE.DstColorFactor;
    ...
    var NoBlending = THREE.NoBlending;
    ...
    var UnsignedShortType = THREE.UnsignedShortType;
    var Vector3 = THREE.Vector3;
    var WebGLRenderTarget = THREE.WebGLRenderTarget;
    var ZeroFactor = THREE.ZeroFactor;

    var Pass = THREE.Pass;
    var SimplexNoise = THREE.SimplexNoise;
    var SSAOShader = THREE.SSAOShader;
    var SSAOBlurShader = THREE.SSAOBlurShader;
    var SSAODepthShader = THREE.SSAODepthShader;
